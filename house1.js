class house1 extends Phaser.Scene {
    constructor() {
    ...
    preload() {
        ...
        this.load.image('rightEye', 'assets/rightEye.png');

        this.load.image('rightEyeObtained', 'assets/messages/rightEyeObtained.png');
    ...
    create() {
        ...
        this.add.image(448, 224, 'house1').setScale(1);
        ...
        this.rightEyeObtainedMessage = this.add.image(220, 350, 'rightEyeObtained').setScrollFactor(1).setScale(0.5).setVisible(false);
        ...
        this.physics.add.overlap(this.grandSon, this.rightEyeItem, this.eyeCollect, null, this);
    ...
    eyeCollect(){
        ...
        this.rightEyeItem.destroy()

        this.rightEyeStatue = true;

        this.rightEyeObtainedMessage.setVisible(true)

        setTimeout(() => {

            this.rightEyeObtainedMessage.setVisible(false)
